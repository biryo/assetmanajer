...
<div class="content-wrapper">
    ...
    <!-- Main content -->
    <form role="form" action="?page=save-maintenance" method="POST" enctype='multipart/form-data'>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Form Create Maintenance</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div class="form-group">
                                <label>Periode Maintenance</label>
                                <input type="text" name="tgl" title="dd-mm-yyyy" class="form-control datepicker" placeholder="Masukan Periode / Tanggal Maintenance" autocomplete="off" required="">
                            </div>
                            <div class="form-group">
                                <label>Deskripsi Maintenance</label>
                                <textarea name="deskrip" class="form-control" placeholder="Masukan Deskripsi Maintenance" required=""></textarea>
                            </div>
                        </div>
                    </div>
                </div>
